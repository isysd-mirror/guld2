...
- [x] `guld-provider` EIP-1193-shaped `request` API (moved to `~/Projects/guld-extension/provider` — not protocol)
...
- [x] Extension shell (moved to `~/Projects/guld-extension` — not protocol)
- [ ] P2P
